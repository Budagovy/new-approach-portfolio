...
.heading{display:flex;align-items:center;justify-content:space-between;gap:16px;min-height:48px;padding:0 22px}
.experience{display:flex;align-items:baseline;gap:16px;min-width:0}.title-copy{min-width:0}.separator{color:var(--strip-muted);margin:0 8px}.separator[hidden]{display:none}.number{font:12px monospace;color:var(--strip-accent)}
.company{font-size:28px;letter-spacing:-1.1px;font-weight:500}.role{color:var(--strip-muted);font-size:17px}
button{font:inherit;color:inherit;cursor:pointer}.next{border:0;background:none;font-size:11px;letter-spacing:1.4px;color:var(--strip-muted);padding:12px 0;white-space:nowrap}
button:focus-visible{outline:2px solid var(--strip-accent);outline-offset:3px}
.scene{position:relative;height:clamp(110px,9vw,160px);overflow:hidden;isolation:isolate;cursor:pointer}
...
.walker{position:absolute;left:13%;bottom:2px;width:auto;height:82%;aspect-ratio:500/685;z-index:3;border:0;padding:0;background:transparent;overflow:visible;transform:translateX(-50%)}
...
@media(max-width:600px){.heading{padding:0 12px;gap:8px}.experience{gap:9px}.heading{min-height:68px}.company{font-size:18px}.title-copy{line-height:1.35}.separator{margin:0 4px}.role{font-size:12px}.next{font-size:9px;letter-spacing:.5px}.walker{left:20%;height:72%}.pause{opacity:.7}.scene{height:110px}}
